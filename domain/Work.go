...
type Work struct {
	...
	StateBeginTime   common.Timestamp `json:"stateBeginTime" sql:"type:DATETIME(6)"`
	ProcessBeginTime common.Timestamp `json:"processBeginTime" sql:"type:DATETIME(6)"`
	ProcessEndTime   common.Timestamp `json:"processEndTime" sql:"type:DATETIME(6)"`

	// Properties []PropertyAssign `json:"properties"`

	ArchiveTime common.Timestamp `json:"archivedTime" sql:"type:DATETIME(6)"`
}
